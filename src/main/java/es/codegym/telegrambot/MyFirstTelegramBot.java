...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    ...
    public static final String NAME = "Codegymili_bot";
    public static final String TOKEN = "6651606588:AAEUYCvg7eJvOq-oRpUxg0STxfCJ6GlklKI";
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if(getCallbackQueryButtonKey().equals("step_5_btn")){
            ...
            sendTextMessageAsync(STEP_6_TEXT,
                    Map.of("Graba a tus amigos gatos! +40 de fama","step_6_btn",
                    "Grábate cantando en un espejo! +40 de fama", "step_6_btn",
                    "Grábate dando un gran salto! +40 de fama", "step_6_btn"));
        ...
        if(getCallbackQueryButtonKey().equals("step_7_btn")){
            ...
            sendTextMessageAsync(STEP_8_TEXT,
                    Map.of("Felicidades, disfruta de tu fama!","step_8_btn"));
        }
